package container.ConcurrentHashMap.cache;
 ...
 * User study https://blog.csdn.net/sureSand/article/details/82190636
 */
public class ConcurrentHashMapCacheUtils {
    ...
    public static void setCache(String cacheKey, Object cacheValue, long cacheTime) {
        ...
        checkSize();//检查大小，超过就删除过期或者最长未使用缓存
